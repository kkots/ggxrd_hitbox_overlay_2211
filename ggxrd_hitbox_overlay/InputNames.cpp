...
void fillInInputNames() {
	...
	inputNames[/*0x3f*/INPUT_NOT_1] = { "hold any direction but 1", MULTIWORD_MOTION, -1 };
	inputNames[/*0x40*/INPUT_NOT_4_OR_1_OR_2] = { "hold any direction but 4/1/2", MULTIWORD_MOTION, -1 };
	...
	inputNames[/*0x4c*/INPUT_NOT_2] = { "hold any direction but 2", MULTIWORD_MOTION, -1 };
	inputNames[/*0x4d*/INPUT_NOTANYDOWN] = { "hold any direction but 1/2/3", MULTIWORD_MOTION, -1 };
	inputNames[/*0x51*/INPUT_3] = { "3", MOTION, -1 };
	inputNames[/*0x52*/INPUT_6_OR_3_OR_2] = { "6/3/2", MOTION, -1 };
	inputNames[/*0x59*/INPUT_NOT_3] = { "hold any direction but 3", MULTIWORD_MOTION, -1 };
	inputNames[/*0x5a*/INPUT_NOT_6_OR_3_OR_2] = { "hold any direction but 6/3/2", MULTIWORD_MOTION, -1 };
	...
	inputNames[/*0x66*/INPUT_NOT_4] = { "hold any direction but 4", MULTIWORD_MOTION, -1 };
	inputNames[/*0x67*/INPUT_NOTANYBACK] = { "hold any direction but 7/4/1", MULTIWORD_MOTION, -1 };
	inputNames[/*0x6b*/INPUT_5] = { "5", MOTION, -1 };
	inputNames[/*0x6c*/INPUT_ALWAYS_TRUE_DUPLICATE] = { "nullptr", MULTIWORD_MOTION, -1 };
	inputNames[/*0x73*/INPUT_NOT_5] = { "hold any direction but 5", MULTIWORD_MOTION, -1 };
	...
	inputNames[/*0x80*/INPUT_NOT_6] = { "hold any direction but 6", MULTIWORD_MOTION, -1 };
	inputNames[/*0x81*/INPUT_NOTANYFORWARD] = { "hold any direction but 9/6/3", MULTIWORD_MOTION, -1 };
	inputNames[/*0x85*/INPUT_7] = { "7", MOTION, -1 };
	inputNames[/*0x86*/INPUT_4_OR_7_OR_8] = { "4/7/8", MOTION, -1 };
	inputNames[/*0x8d*/INPUT_NOT_7] = { "hold any direction but 7", MULTIWORD_MOTION, -1 };
	inputNames[/*0x8e*/INPUT_NOT_4_OR_7_OR_8] = { "hold any direction but 4/7/8", MULTIWORD_MOTION, -1 };
	...
	inputNames[/*0x9a*/INPUT_NOT_8] = { "hold any direction but 8", MULTIWORD_MOTION, -1 };
	inputNames[/*0x9b*/INPUT_NOTANYUP] = { "hold any direction but 7/8/9", MULTIWORD_MOTION, -1 };
	inputNames[/*0x9f*/INPUT_9] = { "9", MOTION, -1 };
	inputNames[/*0xa0*/INPUT_6_OR_9_OR_8] = { "6/9/8", MOTION, -1 };
	inputNames[/*0xa7*/INPUT_NOT_9] = { "hold any direction but 9", MULTIWORD_MOTION, -1 };
	inputNames[/*0xa8*/INPUT_NOT_6_OR_9_OR_8] = { "hold any direction but 6/9/8", MULTIWORD_MOTION, -1 };
