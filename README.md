...
- 2025 December 23: Version 7.18: Fixed a crash that was happening when the mod is present during an online non-observer match, caused by changes since version 7.16. It was caused by writing past the bounds of a projectile framebar's 'frames' heap buffer when reverting framebars to a previous state in correspondence with the game's rollback.