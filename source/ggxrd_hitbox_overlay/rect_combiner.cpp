...
void RectCombiner::getOutlines(std::vector<Polygon>& boxes,
    ...
    for (const auto& box : boxes) {
        ...
        /*for (GridLine* currentI = box.leftLine; currentI != box.rightLine; ++currentI) {
            for (GridLine* currentJ = box.topLine; currentJ != box.bottomLine; ++currentJ) {
                gridSpace.getCell(currentI->index, currentJ->index).filled = true;
            }
        }*/
    }
