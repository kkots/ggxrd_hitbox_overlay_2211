...
with open("ggxrd_hitbox_injector.rc", "rt", encoding="utf-16") as f:
 resource_lines = f.read().splitlines()

new_version = common_prebuild.parse_version("InjectorVersion.h")
if new_version is None:
 exit(1)

need_write = False
if common_prebuild.replace_about_dlg(resource_lines, new_version):
 need_write = True

if common_prebuild.replace_app_title(resource_lines, new_version):
 need_write = True
...
if need_write:
 print("Updating ggxrd_hitbox_injector.rc...")
 with open("ggxrd_hitbox_injector.rc", "wt", encoding="utf-16le", newline="\r\n") as f:
...
if need_write or compare_filetimes("ggxrd_hitbox_injector_utf8.rc", "ggxrd_hitbox_injector.rc") < 0:
 print("Writing ggxrd_hitbox_injector_utf8.rc...")
 with open("ggxrd_hitbox_injector_utf8.rc", "wt", encoding="utf-8") as f:
