...
with open("ggxrd_hitbox_patcher.rc", "rt", encoding="utf-16") as f:
 resource_lines = f.read().splitlines()

new_version = common_prebuild.parse_version("PatcherVersion.h")
...
if need_write:
 print("Updating ggxrd_hitbox_patcher.rc...")
 with open("ggxrd_hitbox_patcher.rc", "wt", encoding="utf-16le", newline="\r\n") as f:
...
if need_write or compare_filetimes("ggxrd_hitbox_patcher_utf8.rc", "ggxrd_hitbox_patcher.rc") < 0:
 print("Writing ggxrd_hitbox_patcher_utf8.rc...")
 with open("ggxrd_hitbox_patcher_utf8.rc", "wt", encoding="utf-8") as f:
